        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <form name="orders" action="{{ url("admin.orders.store") }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <a href="#" id="addtocart" class="btn btn-primary" style="margin: 10px 0">Thêm sản phẩm này vào đơn hàng</a>
                            </div>
...
@section('appendjs')
    ...
    <link rel="stylesheet" href="{{ asset("/vendor/js/select2/select2.min.css") }}" />
